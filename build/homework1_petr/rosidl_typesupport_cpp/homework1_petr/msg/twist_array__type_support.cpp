...
static const _TwistArray_type_support_symbol_names_t _TwistArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, homework1_petr, msg, TwistArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, homework1_petr, msg, TwistArray)),
  }
};
...
{
  return &::homework1_petr::msg::rosidl_typesupport_cpp::TwistArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, homework1_petr, msg, TwistArray)() {
  return get_message_type_support_handle<homework1_petr::msg::TwistArray>();
}
