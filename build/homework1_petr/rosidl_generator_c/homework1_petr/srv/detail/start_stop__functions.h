...
#ifndef HOMEWORK1_PETR__SRV__DETAIL__START_STOP__FUNCTIONS_H_
#define HOMEWORK1_PETR__SRV__DETAIL__START_STOP__FUNCTIONS_H_
...
/// Initialize srv/StartStop message.
/**
...
/// Finalize srv/StartStop message.
/**
...
/// Create srv/StartStop message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * homework1_petr__srv__StartStop_Request__init().
...
/// Destroy srv/StartStop message.
/**
 * It calls
 * homework1_petr__srv__StartStop_Request__fini()
...
/// Check for srv/StartStop message equality.
/**
...
/// Initialize array of srv/StartStop messages.
/**
...
/// Finalize array of srv/StartStop messages.
/**
 * It calls
 * homework1_petr__srv__StartStop_Request__fini()
...
/// Create array of srv/StartStop messages.
/**
 * It allocates the memory for the array and calls
 * homework1_petr__srv__StartStop_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StartStop messages.
/**
 * It calls
 * homework1_petr__srv__StartStop_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StartStop message array equality.
/**
...
/// Copy an array of srv/StartStop messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * homework1_petr__srv__StartStop_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_homework1_petr
...
/**
 * It calls
 * homework1_petr__srv__StartStop_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_homework1_petr
...
/**
 * It allocates the memory for the array and calls
 * homework1_petr__srv__StartStop_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_homework1_petr
...
/**
 * It calls
 * homework1_petr__srv__StartStop_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HOMEWORK1_PETR__SRV__DETAIL__START_STOP__FUNCTIONS_H_
