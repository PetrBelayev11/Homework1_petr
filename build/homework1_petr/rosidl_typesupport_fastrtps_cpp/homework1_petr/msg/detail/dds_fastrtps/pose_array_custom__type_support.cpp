...
#include "homework1_petr/msg/detail/pose_array_custom__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = homework1_petr::msg::PoseArrayCustom;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const homework1_petr::msg::PoseArrayCustom *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<homework1_petr::msg::PoseArrayCustom *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PoseArrayCustom__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const homework1_petr::msg::PoseArrayCustom *>(
...
static size_t _PoseArrayCustom__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PoseArrayCustom(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PoseArrayCustom__callbacks = {
  "homework1_petr::msg",
  "PoseArrayCustom",
...
static rosidl_message_type_support_t _PoseArrayCustom__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PoseArrayCustom__callbacks,
...
{
  return &homework1_petr::msg::typesupport_fastrtps_cpp::_PoseArrayCustom__handle;
}
